...
(function () {
  ...
  $.paste = function (pasteContainer) {
    ...
    if (typeof console !== "undefined" && console !== null) {
      console.log(
        "DEPRECATED: This method is deprecated. Please use $.fn.pastableNonInputable() instead."
      );
    }
  ...
  isFocusable = function (element, hasTabindex) {
    ...
    focusableIfVisible =
      focusableIfVisible || $(element).is("[contenteditable]");
  ...
  Paste = (function () {
    ...
    Paste.mountNonInputable = function (nonInputable) {
      var paste;
      paste = new Paste(
        createHiddenEditable().appendTo(nonInputable),
        nonInputable
      );
      $(nonInputable).on(
        "click",
    ...
    Paste.mountTextarea = function (textarea) {
      ...
      if (
        ...
        ((ref = Object.getOwnPropertyDescriptor) != null
          ? (ref1 = ref.call(Object, DataTransfer.prototype, "items")) != null
            ? ref1.get
            : void 0
          : void 0)
      ) {
      ...
      paste = new Paste(
        createHiddenEditable().insertBefore(textarea),
        textarea
      );
      ctlDown = false;
      ...
      return $(paste._target).on(
        ...
        (function (_this) {
          return function (ev, data) {
            ...
            $(textarea).val(
              "" +
                content.slice(0, curStart) +
                data.text +
                content.slice(curEnd)
            );
            $(textarea)[0].setSelectionRange(
              curStart + data.text.length,
              curStart + data.text.length
            );
        ...
        (function (_this) {
          return function (ev) {
            var _i,
              ...
              text;
            _this.originalEvent =
              ev.originalEvent !== null ? ev.originalEvent : null;
            _this._paste_event_fired = true;
            if (
              ((ref = ev.originalEvent) != null ? ref.clipboardData : void 0) !=
              null
            ) {
                ...
                for (_i = k = 0, len1 = ref2.length; k < len1; _i = ++k) {
                  ...
                  if (item.type === "text/plain") {
                    if (
                      ...
                      clipboardData.items[1].type.match(/^image\//)
                    ) {
            ...
            if ((clipboardData = window.clipboardData)) {
              if (
                (ref3 = text = clipboardData.getData("Text")) != null
                  ? ref3.length
                  : void 0
              ) {
                setTimeout(function () {
